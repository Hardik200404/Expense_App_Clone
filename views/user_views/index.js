function handle_signup(event){
    ...
    fetch('http://13.201.104.73:3000/user/signup',{
        method: 'POST',
        headers: {
...
function handle_signin(event){
    ...
    fetch('http://13.201.104.73:3000/user/login',{
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function handle_forgot_password(event){
    ...
    axios.post('http://13.201.104.73:3000/password/forgot-password',{
        email: event.target.email.value
    })
    .then(response=>{
        //console.log(response)
...
function handle_reset_password(event){
    ...
    axios.post('http://13.201.104.73:3000/password/reset-new-password',{
