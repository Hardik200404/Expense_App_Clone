...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //check if premium
    fetch('http://13.201.104.73:3000/user/check-premium',{
        method: 'GET',
...
function fetch_expenses(page, limit) {
    fetch(`http://13.201.104.73:3000/expense/get-expenses-paginated?page=${page}&limit=${limit}`,{
        method: 'GET',
        contentType: 'application/json',
...
function handle_submit(event){
    ...
    fetch('http://13.201.104.73:3000/expense/add-expense',{
        method: 'POST',
...
function delete_expense(id) {
    ...
    fetch(`http://13.201.104.73:3000/expense/delete-expense/${id}`, {
        method: 'DELETE',
        headers: {'Authorization': localStorage.getItem('token')}
    })
    .then(response => {
