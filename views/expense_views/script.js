function buy_premium(event){
    fetch('http://13.201.73.46:3000/user/purchase-premium',{
        method: 'GET',
        ...
        let options = {
            ...
            'handler': function(response){
                axios.post('http://13.201.73.46:3000/user/update-transaction-status',{
...
function show_leaderboard(event){
    ...
    axios.get('http://13.201.73.46:3000/premium/leaderboard')
    .then(response=>{
